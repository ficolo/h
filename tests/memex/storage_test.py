...
def AnnotationTransformEvent(patch):
    return patch('memex.storage.AnnotationTransformEvent')
...
@pytest.fixture
def partial(patch):
    return patch('memex.storage.partial')


@pytest.fixture
def postgres_enabled(patch):
    return patch('memex.storage._postgres_enabled')
...
@pytest.fixture
def transform(patch):
    return patch('memex.storage.transform')
