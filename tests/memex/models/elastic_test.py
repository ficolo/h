...
from memex.models.elastic import Document, DocumentMeta, DocumentURI
...
class TestAnnotation(object):
    ...
    def link_text(self, patch):
        return patch('memex.models.elastic.Annotation.link_text',
                     autospec=None,
                     new_callable=PropertyMock)

    @pytest.fixture
    def title(self, patch):
        return patch('memex.models.elastic.Annotation.title',
                     autospec=None,
                     new_callable=PropertyMock)

    @pytest.fixture
    def href(self, patch):
        return patch('memex.models.elastic.Annotation.href',
                     autospec=None,
                     new_callable=PropertyMock)

    @pytest.fixture
    def hostname_or_filename(self, patch):
        return patch('memex.models.elastic.Annotation.hostname_or_filename',
                     autospec=None,
                     new_callable=PropertyMock)

    @pytest.fixture
    def target_uri(self, patch):
        return patch('memex.models.elastic.Annotation.target_uri',
                     autospec=None,
                     new_callable=PropertyMock)

    @pytest.fixture
    def uri_normalize(self, patch):
        return patch('memex.models.elastic.uri.normalize')
